 ...
 * Public class Client1 is a java program that functions as the client for a chat program
 */
import java.util.*;
import java.io.*;
import java.awt.*;
...
public class Client1 extends JFrame 
{
    ...
    * void methods main 
    * @Param - String[] args
    * Takes in a string used to identify the Server host and creates a new Client1 object
    */
